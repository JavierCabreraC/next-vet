...
import { BitacoraReport, FiltrosServicio, ReporteDinamico, ServicioReport, VetServicioReport } from "@/types/admin";
import { generateBitacoraPDF, generateDynamicPDF, generateServiciosPDF, generateVetServiciosPDF } from "../../index.admincomp";
